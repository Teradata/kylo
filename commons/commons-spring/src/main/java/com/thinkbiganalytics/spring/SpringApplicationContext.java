...
public class SpringApplicationContext implements ApplicationContextAware {
    ...
    /**
     * Return a Spring bean by its name. This will return a generic object, so you must cast it to the correct class. If the bean does not exist, then a Runtime error will be thrown.
     *
