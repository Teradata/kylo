...
/**
 * Class used to extract field annotations and return as an object describing the annotation and its purpose as well as the Field data A helper class is usually used in conjunction with this class to
 * build up this object parsing Field annotations for a given object/class
 *
