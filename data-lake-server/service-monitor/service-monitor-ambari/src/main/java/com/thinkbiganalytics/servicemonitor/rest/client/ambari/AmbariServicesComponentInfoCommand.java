...
public class AmbariServicesComponentInfoCommand extends AmbariServiceCheckRestCommand<ServiceComponentInfoSummary> {
    ...
    public Map<String, Object> getParameters() {
        ...
        if (serviceList != null) {
            ...
            params.put("fields", "ServiceComponentInfo/Version,ServiceComponentInfo/category,ServiceComponentInfo/StartTime,ServiceComponentInfo/service_name,host_components/HostRoles/host_name,host_components/HostRoles/state");
