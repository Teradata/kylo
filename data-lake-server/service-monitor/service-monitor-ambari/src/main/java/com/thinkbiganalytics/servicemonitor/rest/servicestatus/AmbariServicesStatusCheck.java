...
UNKNOWN 	The component state can not be determined.
  ...
  /**
   * State 	Description INIT 	Initial/Clean state. INSTALLING 	In the process of installing. INSTALL_FAILED 	Install failed.
   * INSTALLED 	State when install completed successfully. STARTING 	In the process of starting. STARTED 	State when start
   * completed successfully. STOPPING 	In the process of stopping. UNINSTALLING 	In the process of uninstalling. UNINSTALLED
   * 	State when uninstall completed successfully. WIPING_OUT 	In the process of wiping out the install. UPGRADING 	In the process
   * of upgrading the deployed bits. DISABLED 	Disabled master’s backup state. UNKNOWN 	State could not be determined.
   */
