...
public class JobsRestController {
    ...
    public Response getJob(@PathParam("executionId") String executionId, @QueryParam(value = "includeSteps") @DefaultValue("false") boolean includeSteps) {
    ...
    @Path("/")
    @Produces({MediaType.APPLICATION_JSON })
    public  SearchResult findJobs(@QueryParam("sort")@DefaultValue("") String sort,@QueryParam("limit") @DefaultValue("10")Integer limit, @QueryParam("start") @DefaultValue("1") Integer start, @Context HttpServletRequest request)
    {


            List<ColumnFilter>filters = WebColumnFilterUtil.buildFiltersFromRequestForDatatable(request, DataTableColumnFactory.PIPELINE_DATA_TYPE.JOB);
    ...
    @GET
    @Path("/list")
    public  List<ExecutedJob> findJobsList(@QueryParam("sort") @DefaultValue("") String sort,@QueryParam("limit") @DefaultValue("10")Integer limit, @QueryParam("start") @DefaultValue("1") Integer start, @Context HttpServletRequest request)
    {
    ...
    @Path("/running")
    @Produces({MediaType.APPLICATION_JSON })
    public  SearchResult findRunningJobs(@QueryParam("sort") @DefaultValue("") String sort,@QueryParam("limit") @DefaultValue("10") Integer limit, @QueryParam("start") @DefaultValue("1") Integer start, @Context HttpServletRequest request)
    {
   ...
   return searchResult;
    ...
    @Path("/failed")
    @Produces({MediaType.APPLICATION_JSON })
    public  SearchResult findFailedJobs(@QueryParam("sort") @DefaultValue("") String sort,@QueryParam("limit") @DefaultValue("10") Integer limit, @QueryParam("start") @DefaultValue("1") Integer start, @Context HttpServletRequest request)
    {
    ...
    @Path("/stopped")
    @Produces({MediaType.APPLICATION_JSON })
    public  SearchResult findStoppedJobs(@QueryParam("sort") @DefaultValue("") String sort,@QueryParam("limit") @DefaultValue("10") Integer limit, @QueryParam("start") @DefaultValue("1") Integer start, @Context HttpServletRequest request)
    {
    ...
    @Path("/completed")
    @Produces({MediaType.APPLICATION_JSON })
    public  SearchResult findCompletedJobs(@QueryParam("sort") @DefaultValue("") String sort,@QueryParam("limit") @DefaultValue("10") Integer limit, @QueryParam("start") @DefaultValue("1") Integer start, @Context HttpServletRequest request)
    {
    ...
    @Path("/abandoned")
    @Produces({MediaType.APPLICATION_JSON })
    public  SearchResult findAbandonedJobs(@QueryParam("sort") @DefaultValue("") String sort,@QueryParam("limit") @DefaultValue("10") Integer limit, @QueryParam("start") @DefaultValue("1") Integer start, @Context HttpServletRequest request)
    {
    ...
    @Produces({MediaType.APPLICATION_JSON })
    public  SearchResult findJobActivity(@PathParam("timeframe") String timeframe, @QueryParam("sort") @DefaultValue("") String sort,@QueryParam("limit") @DefaultValue("10") Integer limit, @QueryParam("start") @DefaultValue("1") Integer start, @Context HttpServletRequest request) {
    ...
    @Produces({MediaType.APPLICATION_JSON })
    public  List<JobStatusCount> findDailyStatusCount(@PathParam("timeframe") String timeframe,@PathParam("amount") Integer amount)
    {
