...
import com.thinkbiganalytics.jobrepo.query.job.ActiveJobQuery;
import com.thinkbiganalytics.jobrepo.query.job.ChildJobsQuery;
import com.thinkbiganalytics.jobrepo.query.job.JobQuery;
import com.thinkbiganalytics.jobrepo.query.job.JobQueryConstants;
import com.thinkbiganalytics.jobrepo.query.job.JobStatusCountQuery;
import com.thinkbiganalytics.jobrepo.query.job.LatestJobExecutionsQuery;
import com.thinkbiganalytics.jobrepo.query.job.LatestJobStatusCountQuery;
...
import com.thinkbiganalytics.jobrepo.query.model.JobParameterTypeImpl;
...
public class JobDao extends BaseQueryDao {
  ...
  public List<ExecutedJob> findAllExecutedJobs(List<ColumnFilter> conditions, List<OrderBy> order, final Integer start,
                                               final Integer limit) {
    JobQuery jobQuery = getJobQuery(conditions);
  ...
  public List<ExecutedJob> findLatestExecutedJobs(List<ColumnFilter> conditions, List<OrderBy> order, final Integer start,
                                                  final Integer limit) {
  ...
  public List<ExecutedJob> findChildJobs(String parentJobExecutionId, boolean includeParent, final Integer start,
                                         final Integer limit) {
    List<ExecutedJob> jobs = new ArrayList<ExecutedJob>();
    ...
    try {
      ...
      if (rows != null) {
        for (Map<String, Object> row : rows) {
          list.add(new JobParameterTypeImpl((String) row.get("KEY_NAME"), (String) row.get("STRING_VAL"),
                                            (String) row.get("TYPE_CD")));
        }
      }
    } catch (Exception e) {
