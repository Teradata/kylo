...
public class DefaultQueryBuilder<T> implements QueryBuilder<T> {
    ...
    @Override
    public Query buildWithQueryModifiers(ColumnFilterQueryModifier columnFilterQueryModifier, OrderByQueryModifier orderByQueryModifier) {
