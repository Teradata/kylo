...
/**
 * Base Query Class for the Jobs -> Check Data Jobs Tab.
 * Shows Job Information as well as the Validation Key and Validation Message supplied from the Check Data Jobs
 */
