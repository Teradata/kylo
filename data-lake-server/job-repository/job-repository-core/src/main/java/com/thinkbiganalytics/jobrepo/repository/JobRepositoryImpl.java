...
import static com.thinkbiganalytics.jobrepo.repository.RepositoryUtils.*;


/**
 * Simple repository abstraction to spring's job explorer that delivers a flattened json friendly view of current
...
public class JobRepositoryImpl implements JobRepository {
	 ...
	 * ordered by job instance id desc
	 *
	...
	/**
	 * return a list of JobStatusCounts based upon looking back for a given Date Part and interval
	 * If the minimum Date for the given interval is not included in the returned list then it will add a Date matching the minimum date with a count of 0.
	 * @param datePart
	 * @param interval
	 * @return
	 */
