...
/**
 * Represents all of the information about a job that was executed in a JSON friendly
 * format.  The native spring objects for this are not JSON friendly.
 */
...
public class DefaultExecutedJob implements Serializable, ExecutedJob {
	...
	public String getDisplayStatus() {
		...
		if(ExecutionStatus.FAILED.equals(this.status) || (ExecutionStatus.COMPLETED.equals(this.status) && "FAILED".equalsIgnoreCase(this.exitCode))){
