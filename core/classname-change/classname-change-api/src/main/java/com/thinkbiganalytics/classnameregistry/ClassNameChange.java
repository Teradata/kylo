...
/**
 * Classes that are stored in the Kylo metadata may change their package name or class name over time.
 * If these objects, especially those stored as JSON objects in our metadata store change their signature overtime, the framework needs to know of these changes and create the correct object if the old class doesnt exist
 ...
 *
 *  @ClassNameChange(classNames = {"com.thinkbiganalytics.old.pkg.MyClass"})
 * public class MyNewClas { ...}
 *
 */
