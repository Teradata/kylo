...
/**
 * Repository for testing query augmentation
 */
public class TestFeedSecuringRepository extends AugmentableQueryRepositoryImpl {

    private static final Logger LOG = LoggerFactory.getLogger(TestFeedSecuringRepository.class);

    public TestFeedSecuringRepository(JpaEntityInformation entityInformation, EntityManager em) {
