...
public class FeedQueryUtil {
  ...
  public static String feedQueryJoin(String jobExecutionTableAlias, String feedNameAlias, boolean onlyFeeds) {
    ...
    sql +=
        "INNER JOIN BATCH_JOB_EXECUTION_PARAMS jobType on jobType.JOB_EXECUTION_ID = " + jobExecutionTableAlias
        + ".JOB_EXECUTION_ID " +
    ...
    sql +=
        " INNER JOIN BATCH_JOB_EXECUTION_PARAMS " + feedNameAlias + " on " + feedNameAlias + ".JOB_EXECUTION_ID = "
        + jobExecutionTableAlias + ".JOB_EXECUTION_ID " +
