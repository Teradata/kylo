define(["require", "exports", "./common/module-require", "@uirouter/angular", "kylo-services", "./main/IndexController", "./main/HomeController", "./main/AccessDeniedController"], function (require, exports, module_require_1) {
    "use strict";
    ...
    var Route = /** @class */ (function () {
        ...
        function Route() {
            //  this.app = app;
            /*this.*/ module_require_1.app.config(["$ocLazyLoadProvider", "$stateProvider", "$urlRouterProvider", this.configFn.bind(this)]);
            /*this.*/ module_require_1.app.run(['$rootScope', '$state', '$location', "$transitions", "$timeout", "$q", "$uiRouter", "AccessControlService", "AngularModuleExtensionService",
                this.runFn.bind(this)]);
        }
        //var app = angular.module("", ["ngRoute"]);
        Route.prototype.configFn = function ($ocLazyLoadProvider, $stateProvider, $urlRouterProvider) {
