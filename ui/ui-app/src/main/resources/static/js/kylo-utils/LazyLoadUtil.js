define(["require", "exports", "underscore"], function (require, exports, _) {
    ...
    var LazyLoadUtilClass = /** @class */ (function () {
        function LazyLoadUtilClass() {
            /**
        ...
        return LazyLoadUtilClass;
    }());
    var lazyLoadUtil = new LazyLoadUtilClass();
    exports.default = lazyLoadUtil;
});
//# sourceMappingURL=LazyLoadUtil.js.map