...
describe("Class: SparkQueryParser", function () {
    ...
    it("should produce Spark for multiple tables", mocks.inject(function (VisualQueryService: any) {
        const spark = new SparkQueryParser(VisualQueryService).toScript({
            "nodes": [{
                "id": 10,
                "name": "sample.t1",
    ...
    it("should produce Spark for pre-joined tables", mocks.inject(function (VisualQueryService: any) {
        const spark = new SparkQueryParser(VisualQueryService).toScript({
            "nodes": [{
                "id": 10,
                "name": "tickit.users",
    ...
    it("should produce Spark for multiple join conditions", mocks.inject(function (VisualQueryService: any) {
        const spark = new SparkQueryParser(VisualQueryService).toScript({
            "nodes": [{
                "id": 11,
                "name": "tickit.sales",
    ...
    it("should produce Spark for multiple data sources", mocks.inject(function (VisualQueryService: any) {
        const spark = new SparkQueryParser(VisualQueryService).toScript({
            "nodes": [{
                "id": 10,
                "name": "sample.t1",
