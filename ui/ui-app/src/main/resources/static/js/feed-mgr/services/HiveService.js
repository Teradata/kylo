define(['angular','services/module-name'], function (angular,moduleName) {
    angular.module(moduleName).factory('HiveService', ["$q","$http","$mdDialog","RestUrlService",function ($q, $http, $mdDialog, RestUrlService) {
