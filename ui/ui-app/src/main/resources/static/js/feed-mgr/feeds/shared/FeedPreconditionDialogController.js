define(["require", "exports", "angular", "underscore"], function (require, exports, angular, _) {
    ...
    var FeedPreconditionsDialogController = /** @class */ (function () {
        function FeedPreconditionsDialogController($scope, $mdDialog, $mdToast, $http, StateService, FeedService, PolicyInputFormService, feed, index) {
            this.$scope = $scope;
        ...
        ;
        return FeedPreconditionsDialogController;
    }());
    exports.FeedPreconditionsDialogController = FeedPreconditionsDialogController;
...
//# sourceMappingURL=FeedPreconditionDialogController.js.map