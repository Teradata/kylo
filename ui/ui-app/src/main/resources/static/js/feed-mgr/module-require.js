...
define(['angular',
        ...
        'feed-mgr/services/RegisterTemplateServiceFactory',
        ...
        'feed-mgr/services/DefaultFeedPropertyService',
        ...
        'feed-mgr/services/CodeMirrorService',
        ...
        'feed-mgr/shared/entity-access-control/EntityAccessControlDialogService',
        'feed-mgr/shared/profile-stats/ProfileStats',
        'feed-mgr/services/UiComponentsService',
        'feed-mgr/services/DomainTypesService',
        'feed-mgr/visual-query/transform-data/profile-stats/column-analysis',
