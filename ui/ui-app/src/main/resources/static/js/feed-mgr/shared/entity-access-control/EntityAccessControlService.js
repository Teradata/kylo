define(["require", "exports", "angular", "underscore", "../../../constants/AccessConstants"], function (require, exports, angular, _, AccessConstants_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var moduleName = require('feed-mgr/module-name');
    var EntityAccessControlService = /** @class */ (function () {
        function EntityAccessControlService() {
        }
        return EntityAccessControlService;
    }());
    exports.EntityAccessControlService = EntityAccessControlService;
    ...
    angular.module(moduleName).factory('EntityAccessControlService', ["$http", "$q", "AccessControlService", "RestUrlService", function ($http, $q, AccessControlService, RestUrlService) {
            ...
            var svc = angular.extend(EntityAccessControlService.prototype, AccessConstants_1.default);
        ...
        $scope.onSave = function ($event) {
            ...
            if ($scope.allowIndexing != $scope.entity.allowIndexing) {
                ...
                FeedService.saveFeedModel(copy).then(function (response) {
                    ...
                    var roleMembershipChanges = EntityAccessControlService.saveRoleMemberships($scope.entityType, $scope.entity.id, $scope.entity.roleMemberships, function (r) {
                        if (angular.isFunction(callbackEvents.onSave)) {
                            callbackEvents.onSave(r);
                        }
                        $mdDialog.hide();
    ...
    angular.module(moduleName).controller('EntityAccessControlDialogController', ["$scope", '$mdDialog', "$q", "$http", "RestUrlService", "EntityAccessControlService", "entity", "entityType", "entityTitle", "callbackEvents", "FeedService", controller]);
});
