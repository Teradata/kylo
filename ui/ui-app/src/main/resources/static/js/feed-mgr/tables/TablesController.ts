...
export class TablesController {
    ...
    constructor(private $scope:any,private $http:any,private $q:any,private $transition$:any,private RestUrlService:any
        , private PaginationDataService:any,private TableOptionsService:any, private AddButtonService:any, private FeedService:any
        , private StateService:any,private Utils:any, private $filter:any){
...
angular.module(moduleName).controller('TablesController',["$scope","$http","$q","$transition$","RestUrlService","PaginationDataService","TableOptionsService","AddButtonService","FeedService","StateService","Utils", "$filter", TablesController]);
