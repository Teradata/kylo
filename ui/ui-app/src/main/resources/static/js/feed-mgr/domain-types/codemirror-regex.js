define(["require", "exports", "../../codemirror-require/module"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var CodeMirrorRegex = (function () {
        function codeMirrorRegexFn() {
            ...
            var tokenBase = function (stream) {
                ...
                if (ch == "\\" && stream.match(/./, false)) {
                    ...
                    if (stream.match(/u/))
                        return "regex-error";
                    if (stream.match(/x\w{2}/))
                        return "regex-esc";
                    if (stream.match(/x/))
                        return "regex-error";
                    if (stream.match(/[wWdDsS]/))
...
//# sourceMappingURL=codemirror-regex.js.map