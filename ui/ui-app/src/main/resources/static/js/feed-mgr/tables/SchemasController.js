define(["require", "exports", "angular"], function (require, exports, angular) {
    ...
    var SchemasController = /** @class */ (function () {
        function SchemasController($scope, $http, $q, $transition$, RestUrlService, PaginationDataService, TableOptionsService, AddButtonService, FeedService, StateService, DatasourcesService) {
            this.$scope = $scope;
            this.$http = $http;
            this.$q = $q;
    ...
    angular.module(moduleName).controller('SchemasController', ["$scope", "$http", "$q", "$transition$", "RestUrlService", "PaginationDataService", "TableOptionsService", "AddButtonService", "FeedService", "StateService", "DatasourcesService", SchemasController]);
});
