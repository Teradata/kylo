    ...
    var controller = function($scope, $log, $http, $mdToast, $mdDialog, $document, Utils, RestUrlService, HiveService, SideNavService, StateService, VisualQueryService, FeedService,
        ...
        function validate() {
            if (self.advancedMode) {
                ...
                feedModel.dataTransformation.datasourceIds = (self.model.selectedDatasourceId && self.model.selectedDatasourceId !== VisualQueryService.HIVE_DATASOURCE)
                    ? [self.model.selectedDatasourceId]
                    : [];
