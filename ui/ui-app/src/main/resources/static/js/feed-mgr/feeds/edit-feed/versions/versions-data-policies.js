define(['angular', 'feed-mgr/feeds/edit-feed/module-name'], function (angular, moduleName) {
    ...
    var directive = function () {
        return {
            ...
            controllerAs: 'vm',
            scope: {},
            templateUrl: 'js/versions-mgr/feeds/edit-feed/details/versions-data-policies.html',
    ...
    var controller = function ($scope, $mdDialog, $timeout, $q, $compile, $sce, AccessControlService, EntityAccessControlService, FeedService, StateService, FeedFieldPolicyRuleService,
        ...
        this.showFieldRuleDialog = function (field) {
            $mdDialog.show({
                ...
                templateUrl: 'js/versions-mgr/shared/versions-field-policy-rules/define-feed-data-processing-field-policy-dialog.html',
        ...
        self.onDomainTypeChange = function (policy) {
            ...
            if ((domainType.field.derivedDataType !== null
                ...
                $mdDialog.show({
                    ...
                    fullscreen: true,
                    parent: angular.element(document.body),
                    templateUrl: "js/versions-mgr/shared/apply-domain-type/apply-domain-type-dialog.html",
                    locals: {
        ...
        self.showEditFieldDialog = function (field) {
            $mdDialog.show({
                ...
                fullscreen: true,
                parent: angular.element(document.body),
                templateUrl: "js/versions-mgr/feeds/edit-feed/versions-details-edit-field-dialog.html",
                locals: {
                    field: field
                }
            }).then(function() {
    ...
    angular.module(moduleName)
        ...
        .directive('thinkbigVersionsDataPolicies', directive);
});
