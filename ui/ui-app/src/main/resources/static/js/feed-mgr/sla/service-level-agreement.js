define(["require", "exports", "angular", "./module-name", "underscore"], function (require, exports, angular, module_name_1, _) {
    ...
    var ServiceLevelAgreementController = /** @class */ (function () {
        ...
        ServiceLevelAgreementController.prototype.$onInit = function () {
            this.ngOnInit();
        };
        ServiceLevelAgreementController.prototype.ngOnInit = function () {
            var _this = this;
            this.loading = true;
            ...
            if (this.slaId) {
                //fetch the sla
                this.SlaService.getSlaForEditForm(this.slaId).then(function (response) {
        ...
        ServiceLevelAgreementController.prototype.onViewTypeChange = function (viewType) {
            this.PaginationDataService.viewType(this.pageName, this.viewType);
        };
        ServiceLevelAgreementController.prototype.onOrderChange = function (order) {
            this.PaginationDataService.sort(this.pageName, order);
            this.TableOptionsService.setSortOption(this.pageName, order);
        };
        ;
        ServiceLevelAgreementController.prototype.onPaginationChange = function (page, limit) {
         ...
         * @param option
         */
        ServiceLevelAgreementController.prototype.selectedTableOption = function (option) {
         ...
         */
        ServiceLevelAgreementController.prototype.cancelEditSla = function () {
            this.showList();
            this.applyAccessPermissions();
            this.userSuppliedName = false;
            this.userSuppliedDescription = false;
        };
        ServiceLevelAgreementController.prototype.addNewCondition = function () {
            this.ruleType = this.EMPTY_RULE_TYPE;
        ...
        ServiceLevelAgreementController.prototype.onPropertyChange = function (property) {
        ...
        ServiceLevelAgreementController.prototype.onNameChange = function () {
            this.userSuppliedName = true;
        };
        ServiceLevelAgreementController.prototype.onDescriptionChange = function () {
            this.userSuppliedDescription = true;
        };
        ServiceLevelAgreementController.prototype.saveSla = function () {
            var _this = this;
         ...
         * @param ev
         */
        ServiceLevelAgreementController.prototype.onBackToList = function (ev) {
            var requery = false;
         ...
         */
        ServiceLevelAgreementController.prototype.onNewSla = function () {
         ...
         * @param sla
         */
        ServiceLevelAgreementController.prototype.onEditSla = function (sla) {
            if (this.allowEdit) {
                this.AddButtonService.hideAddButton();
        ...
        ;
        ServiceLevelAgreementController.prototype.onDeleteSla = function (ev) {
            var _this = this;
        ...
        ServiceLevelAgreementController.prototype.onDeleteSlaMetric = function (index) {
            //warn before delete
        ...
        ServiceLevelAgreementController.prototype.onDeleteSlaAction = function (index) {
            //warn before delete
        ...
        ServiceLevelAgreementController.prototype.onAddConditionRuleTypeChange = function () {
        ...
        ServiceLevelAgreementController.prototype.onAddSlaActionChange = function () {
        ...
        ServiceLevelAgreementController.prototype.viewSlaAssessments = function () {
            if (this.editSla) {
                this.StateService.OpsManager().Sla().navigateToServiceLevelAssessments('slaId==' + this.editSla.id);
            }
        };
        ServiceLevelAgreementController.prototype.loadAndEditSla = function (slaId) {
            var _this = this;
            ...
            this.SlaService.getSlaForEditForm(slaId).then(function (response) {
                ...
                _.each(sla.rules, function (rule) {
                    ...
                    rule.mode = 'EDIT';
                    rule.groups = _this.PolicyInputFormService.groupProperties(rule);
                    _this.PolicyInputFormService.updatePropertyIndex(rule);
                });
                _.each(sla.actionConfigurations, function (rule) {
                    ...
                    _this.PolicyInputFormService.updatePropertyIndex(rule);
                    //validate the rules
                    _this.SlaService.validateSlaActionRule(rule);
                });
        ...
        ServiceLevelAgreementController.prototype.applyEditPermissionsToSLA = function (sla) {
            var _this = this;
         ...
         * @returns {boolean}
         */
        ServiceLevelAgreementController.prototype.validateForm = function () {
        ...
        ServiceLevelAgreementController.prototype._saveSla = function (successFn, failureFn) {
            var _this = this;
            this.$mdDialog.show(this.$mdDialog.alert()
         ...
         * @returns {*[]}
         */
        ServiceLevelAgreementController.prototype.loadSortOptions = function () {
        ...
        ServiceLevelAgreementController.prototype.showList = function (requery) {
            this.cardTitle = "Service Level Agreements";
         ...
         */
        ServiceLevelAgreementController.prototype.loadSlas = function () {
            var _this = this;
            this.loadingMessage = this.loadingListMessage;
            this.loading = true;
            /**
        ...
        ServiceLevelAgreementController.prototype.deriveSlaName = function () {
        ...
        ServiceLevelAgreementController.prototype.deriveDescription = function () {
            var feedNamesString = null;
            var feedNames = this.PolicyInputFormService.getFeedNames(this.editSla.rules);
            if (feedNames.length > 0) {
                feedNamesString = feedNames.join(",");
         ...
         */
        ServiceLevelAgreementController.prototype.applyAccessPermissions = function () {
            var _this = this;
        ...
        ServiceLevelAgreementController.$inject = ["$scope", "$mdDialog", "$mdToast", "$http",
    ...
    angular.module(module_name_1.moduleName).controller('ServiceLevelAgreementController', ServiceLevelAgreementController);
