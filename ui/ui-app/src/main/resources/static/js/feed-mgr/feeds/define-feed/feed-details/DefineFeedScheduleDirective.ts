...
export class DefineFeedScheduleController {
    ...
    waitForStepperControllerRetryAmount:any;
    stepNumber:any;
    model:any;
    timerAmount:any;
    timerUnits:any;
    ...
    isClustered:any;
    savingFeed:any;
    supportsExecutionNode:any;
    scheduleStrategies:any;
    timerChanged:any;
    showTimerAlert:any;
    onScheduleStrategyChange:any;
    showPreconditionDialog:any;
    createFeed:any;
    stepIndex:any;
    deletePrecondition:any;
    ...
    constructor(private $scope:any, private $http:any, private $mdDialog:any, private $timeout:any
        ...
        function updateScheduleStrategies() {
            ...
            if (self.model.schedule.schedulingStrategy) {
                var validStrategy = _.some(self.scheduleStrategies, function(strategy:any) {
         ...
         * @param index
         */
        function onStepStateChange(event:any, index:any) {
            validate();
        }
        ...
        self.showTimerAlert = function(ev:any) {
            $mdDialog.show(
                    $mdDialog.alert()
         ...
         * @param callback
         */
        function waitForStepperController(callback:any) {
            if (self.stepperController) {
        ...
        this.createFeed = function() {
            if(self.defineFeedScheduleForm.$valid) {
                ...
                FeedService.saveFeedModel(self.model).then(function (response:any) {
