 ...
 */
export class ConnectionDialogController {
...
angular.module(moduleName).controller("ConnectionDialogController", ["$scope", "$mdDialog", "isNew", "connectionDataModel", "source", "dest", ConnectionDialogController]);
