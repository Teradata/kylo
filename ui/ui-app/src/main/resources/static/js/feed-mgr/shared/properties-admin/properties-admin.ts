...
const moduleName = require('feed-mgr/module-name');
     ...
     */
    function PropertiesAdminController($scope:any) {
        var self = this;
         ...
         */
        self.moveDown = function(index:any) {
         ...
         * @param index the index of the field
         */
        self.moveUp = function(index:any) {
        ...
        self.onFieldChange = function() {
            ...
            angular.forEach($scope.fieldList, function(field:any) {
        ...
        self.onModelChange = function() {
            if (!angular.equals($scope.model, self.lastModel)) {
                ...
                $scope.fieldList = [];
                angular.forEach($scope.model, function(element:any) {
                ...
                // Sort fields
                $scope.fieldList.sort(function(a:any, b:any) {
         ...
         */
        self.removeField = function(index:any) {
         ...
         */
        self.updateSystemName = function(field:any) {
            if (field.$isNew) {
                field.systemName = field.displayName
                        .replace(/[^a-zA-Z0-9]+([a-zA-Z0-9]?)/g, function(match:any, p1:any) { return p1.toUpperCase(); })
                        .replace(/^[A-Z]/, function(match:any) { return match.toLowerCase(); });
                self.onFieldChange();
            }
        }
    }
