define(['angular','feed-mgr/feeds/edit-feed/module-name'], function (angular,moduleName) {
    ...
    var directive = function() {
        return {
            ...
            controllerAs: 'vm',
            scope: {},
            templateUrl: 'js/versions-mgr/feeds/edit-feed/details/versions-additional-properties.html',
    ...
    angular.module(moduleName).directive('thinkbigVersionsAdditionalProperties', directive);
});
