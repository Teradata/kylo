...
export class DefineFeedTableController {
    ...
    schemaParser:any;
    useUnderscoreInsteadOfSpaces:boolean;
    selectedColumn:any;
    ...
    calcTableState:any;
    syncFeedsColumns:any;
    expandSchemaPanel:any;
    addHistoryItem:any;
    updateSelectedMethod:any;
    validateColumn:any;
    undoColumn:any;
    removeColumn:any;
    addPartitionField:any;
    removePartitionField:any;
    removeColumnUsingReference:any;
    getSelectedColumn:any;
    onSelectedColumn:any;
    onPrecisionChange:any;
    onNameFieldChange:any;
    onFieldChange:any;
    // undoColumn:any;
    fieldErrorCount:any;
    errorMessage:any;
    onPartitionSourceFieldChange:any;
    updatePartitionFieldName:any;
    onPartitionFormulaChange:any;
    getColumnDefinition:any;
    collapseMethodPanel:any;
    // expandSchemaPanel:any;
    expandChooseMethodPanel:any;
    // expandSchemaPanel:any;
    ...
    constructor(private $rootScope:any, private $scope:any, private $http:any, private $timeout:any, private $mdToast:any, private $filter:any, private $mdDialog:any
        ...
        function initFeedColumn(columnDef:any){
         ...
         */
        function createHistoryRecord(columnDef:any) {
         ...
         */
        this.updateSelectedMethod =function(method:any){
            if(method == 'MANUAL' ) {
        ...
        this.addHistoryItem = function(columnDef:any) {
         ...
         */
        function newPartitionField(index:any) {
        ...
        function partitionNamesUnique() {
            ...
            var columnNames = _.map(self.model.table.tableSchema.fields, function (columnDef:any) {
                return columnDef.name;
            });
            var countPartitionNames = {};
            //add the angular errors
            _.each(self.model.table.partitions, function (partition:any) {
         ...
         * @param columnDef
         */
        this.addColumn = function (columnDef:any, syncFieldPolicies:any) {
        ...
        this.undoColumn = function (index:any) {
         ...
         * @param index
         */
        this.removeColumn = function (index:any) {
            ...
            var matchingPartitions = _.filter(self.model.table.partitions, function (partition:any) {
                return partition.columnDef.name == columnDef.name;
            });
            if (matchingPartitions) {
                _.each(matchingPartitions, function (partition:any) {
         ...
         * @param columnDef
         */
        this.removeColumnUsingReference = function (columnDef:any) {
         ...
         * @param index
         */
        this.removePartitionField = function (index:any) {
        ...
        this.onSelectedColumn = function (selectedColumn:any) {
        ...
        this.onPrecisionChange = function(columnDef:any) {
            self.validateColumn(columnDef);
         ...
         * @param columnDef
         */
        this.onNameFieldChange = function(columnDef:any, index:any) {
        ...
        function isDeleted(columnDef:any) {
            return columnDef.deleted === true;
        }

        function isInvalid(columnDef:any) {
            var errorCount = 0;
        ...
        this.fieldErrorCount = function(columnDefField:any) {
        ...
        function updateFormValidation(columnDef:any) {
        ...
        function initValidationErrors(columnDef:any) {
        ...
        this.validateColumn = function(columnDef:any) {
            ...
            var columnsByName = _.groupBy(self.model.table.tableSchema.fields, function(column:any){
        ...
        this.errorMessage = function(columnDef:any) {
        ...
        function add(array:any, element:any) {
            remove(array, element);
            array.push(element);
        }

        this.onFieldChange = function (columnDef:any) {
         ...
         * @param partition
         */
        this.onPartitionSourceFieldChange = function (partition:any) {
         ...
         * @param partition
         */
        this.onPartitionFormulaChange = function (partition:any) {
         ...
         * @param partition
         */
        this.onPartitionNameChange = function (partition:any) {
         ...
         * @returns {*|{}}
         */
        this.getColumnDefinition = function (fieldName:any) {

            return _.find(self.model.table.tableSchema.fields, function (field:any) {
         ...
         * @param partition
         */
        this.updatePartitionFieldName = function (partition:any) {
        ...
        function validate(validForm:any) {
            ...
            if (valid) {
                ...
                var validFields = _.filter(self.model.table.tableSchema.fields,function(field:any) {
        ...
        this.collapseMethodPanel = function () {
            $mdExpansionPanel().waitFor('panelOne').then(function (instance:any) {
                instance.collapse();
            });
        };
        ...
        this.expandSchemaPanel = function () {
            ...
            $mdExpansionPanel().waitFor('panelTwo').then(function (instance:any) {
        ...
        function applyDomainTypes() {
            ...
            self.model.table.tableSchema.fields.forEach(function (field:any, index:any) {
            ...
            if (data.fields.length > 0) {
                $mdDialog.show({
                    ...
                    .then(function (selected:any) {
                        selected.forEach(function (selection:any) {
                            var fieldIndex = data.fields.findIndex(function (element:any) {
                                return element.name === selection.name;
                            });
                            var policyIndex = self.model.table.tableSchema.fields.findIndex(function (element:any) {
                                return element.name === selection.name;
                            });
