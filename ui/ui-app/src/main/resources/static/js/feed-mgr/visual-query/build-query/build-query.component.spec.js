define(["require", "exports", "angular-mocks", "underscore", "feed-mgr/visual-query/module", "feed-mgr/visual-query/module-require"], function (require, exports, mocks, _) {
    ...
    describe("Component: BuildQueryComponent", function () {
        ...
        it("should produce SQL for multiple tables", function () {
            ...
            this.controller.chartViewModel.addNode({
                ...
                nodeAttributes: {
                    attributes: [
                        { name: "id", dataType: "smallint", selected: true },
                        { name: "t1_id", dataType: "smallint", selected: true },
        ...
        it("should produce SQL for pre-joined tables", function () {
            ...
            // Test SQL
            var expected = "SELECT tbl10.`username`, tbl10.`firstname`, tbl10.`lastname`, tbl11.`qtysold`, tbl11.`pricepaid`, tbl11.`commission`" +
...
//# sourceMappingURL=build-query.component.spec.js.map