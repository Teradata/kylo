define(['angular','feed-mgr/feeds/edit-feed/module-name'], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            ...
            controllerAs: 'vm',
            scope: {},
            templateUrl: 'js/versions-mgr/feeds/edit-feed/details/versions-schedule.html',
    ...
    var controller = function ($scope, $http, $mdDialog, $q,AccessControlService, EntityAccessControlService,FeedService, RestUrlService) {
        ...
        this.showPreconditionDialog = function (index) {
            $mdDialog.show({
                ...
                templateUrl: 'js/versions-mgr/feeds/shared/define-feed-preconditions-dialog.html',
                parent: angular.element(document.body),
                clickOutsideToClose: false,
                fullscreen: true,
                locals: {
    ...
    angular.module(moduleName)
        .directive('thinkbigVersionsSchedule', directive);
