define(["require", "exports", "angular", "underscore"], function (require, exports, angular, _) {
    ...
    var TablesController = /** @class */ (function () {
        function TablesController($scope, $http, $q, $transition$, RestUrlService, PaginationDataService, TableOptionsService, AddButtonService, FeedService, StateService, Utils, $filter) {
            this.$scope = $scope;
            this.$http = $http;
            this.$q = $q;
