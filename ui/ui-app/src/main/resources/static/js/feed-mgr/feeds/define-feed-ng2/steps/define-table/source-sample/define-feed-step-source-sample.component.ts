...
@Component({
    ...
    styleUrls: ["js/feed-mgr/feeds/define-feed-ng2/steps/define-table/source-sample/define-feed-step-source-sample.component.css"],
    templateUrl: "js/feed-mgr/feeds/define-feed-ng2/steps/define-table/source-sample/define-feed-step-source-sample.component.html"
})
