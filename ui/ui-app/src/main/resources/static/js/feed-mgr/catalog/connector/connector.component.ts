...
export class ConnectorComponent {
    ...
    initControls() {
        if (this.datasource) {
            ...
            if (optionsMapper) {
                ...
                this.showSnackBar(this.translateService.instant('FEEDMGR.CONNECTOR.UNKNOWN_UI_OPTIONS',
    ...
    saveDatasource() {
        ...
        this.catalogService.createDataSource(ds).pipe(
            ...
            err => {
                console.error(err);
                this.showSnackBar(this.translateService.instant('views.common.save.failed',{entity : ''}), err.message);
            }
        );
    }
