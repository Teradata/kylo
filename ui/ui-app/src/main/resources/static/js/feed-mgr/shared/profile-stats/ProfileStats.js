define(["require", "exports", "angular", "underscore"], function (require, exports, angular, _) {
    ...
    var ProfileStatsController = /** @class */ (function () {
        function ProfileStatsController($scope, $timeout, HiveService) {
            this.$scope = $scope;
            ...
            self.percOptions = {
                chart: {
                    ...
                    margin: {
                        top: 0,
                        right: self.multiBarHorizontalChartMarginRight,
                        bottom: 0,
            ...
            self.selectTopValues = function () {
                ...
                if (_.isUndefined(topN)) {
                    ...
                    topVals = _.map(lines, function (line) {
    ...
    exports.ProfileStatsController = ProfileStatsController;
