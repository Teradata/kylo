...
describe("Class: SparkQueryEngine", function () {
    ...
    describe("get script", function () {
        it("from an array expression", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                              DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                              VisualQueryService: any) {
            // Create service
            const service = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
        ...
        it("from a column expression", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                              DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                              VisualQueryService: any) {
            // Create service
            const service: any = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
        ...
        it("from a DataFrame expression", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                                 DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                                 VisualQueryService: any) {
            // Create service
            const service: any = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
        ...
        it("from a filter expression", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                              DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                              VisualQueryService: any) {
            // Create service
            const service: any = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
            ...
            // Test script
            const formula = "filter(qtysold == 2 && pricepaid - commission > 200)";
            service.push(tern.parse(formula), {});
            expect(service.getScript()).toBe(
                "import org.apache.spark.sql._\n"
                + "var df = sqlContext.sql(\"SELECT * FROM invalid\")\n"
        ...
        it("from an object expression", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                               DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                               VisualQueryService: any) {
            // Create service
            const service: any = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
        ...
        it("from an optional expression", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                                 DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                                 VisualQueryService: any) {
            // Create service
            const service = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
        ...
        it("from a vararg expression", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                              DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                              VisualQueryService: any) {
            // Create service
            const service: any = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
            ...
            // Test script
            const formula = "groupBy(username, eventname).sum(\"qtysold\", \"pricepaid\")";
            service.push(tern.parse(formula), {});
            expect(service.getScript()).toBe(
                "import org.apache.spark.sql._\n"
                + "var df = sqlContext.sql(\"SELECT * FROM invalid\")\n"
    ...
    // limit
    it("should get and set limit", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                          DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                          VisualQueryService: any) {
        const service = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
        service.setQuery("SELECT * FROM invalid");
    ...
    // redo
    it("should redo the last undone transformation", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                                            DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                                            VisualQueryService: any) {
        // Initialize service
        const service: any = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
    ...
    // sample
    it("should get and set sample", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                           DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                           VisualQueryService: any) {
        const service = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
        service.setQuery("SELECT * FROM invalid");
    ...
    it("should limit before sampling", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                              DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                              VisualQueryService: any) {
        const service = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
        service.setQuery("SELECT * FROM invalid");
    ...
    // splice
    it("should splice transformation array", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                                    DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                                    VisualQueryService: any) {
        // Add formulas
        const service = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
    ...
    // undo
    it("should undo the last transformation", mocks.inject(function ($http: angular.IHttpService, $mdDialog: angular.material.IDialogService, $timeout: angular.ITimeoutService,
                                                                     DatasourcesService: DatasourcesServiceStatic.DatasourcesService, HiveService: any, RestUrlService: any, uiGridConstants: any,
                                                                     VisualQueryService: any) {
        // Initialize service
        const service: any = new SparkQueryEngine($http, $mdDialog, $timeout, DatasourcesService, HiveService, RestUrlService, uiGridConstants, VisualQueryService);
