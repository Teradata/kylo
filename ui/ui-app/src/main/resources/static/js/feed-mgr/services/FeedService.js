define(["require", "exports", "angular", "underscore", 'pascalprecht.translate'], function (require, exports, angular, _) {
    "use strict";
    function FeedService($http, $q, $mdToast, $mdDialog, RestUrlService, VisualQueryService, FeedCreationErrorService, FeedPropertyService, AccessControlService, EntityAccessControlService, StateService, $filter) {
            function trim(str) {
                ...
                saveFeedModel: function (model) {
                    ...
                    var successFn = function (response) {
                        ...
                        $mdToast.show($mdToast.simple()
                                    .textContent($filter('translate')('view.FeedService.Fss'))
                            .hideDelay(3000));
    ...
    angular.module(require("feed-mgr/module-name"))
        ...
        "EntityAccessControlService", "StateService", FeedService,"$filter"])
