...
export class FeedService {
     ...
     * @param nifiFeed
     */
    buildErrorData(name: any, response: any) {
    ...
    saveFeedModel(model: any) {
        ...
        return new Promise((resolve, reject) => {
            this.http.post(this.RestUrlService.CREATE_FEED_FROM_TEMPLATE_URL, JSON.stringify(copy),
                { headers: new HttpHeaders({ 'Content-Type': 'application/json; charset=utf-8' }) })
                .toPromise().then((response: any) => {
                    var invalidCount = 0;
                    if (response && response.success) {
                        //update the feed versionId and internal id upon save
                        model.id = response.feedMetadata.id;
                        model.versionName = response.feedMetadata.versionName;
    ...
    isKyloConfiguredForFeedHistoryDataReindexing() {
        return this.http.get(this.RestUrlService.FEED_HISTORY_CONFIGURED).toPromise();
    }
    /**
    ...
    getFeedSummary() {
        ...
        return new Promise((resolve, reject) => {
            this.http.get(this.RestUrlService.GET_FEED_NAMES_URL).toPromise().then(successFn, errorFn);
        });
    }
    /**
     * Call the server to return a list of Feed Names
    ...
    getPossibleFeedPreconditions() {
        ...
        return new Promise((resolve, reject) => {
            this.http.get(this.RestUrlService.GET_POSSIBLE_FEED_PRECONDITIONS_URL).toPromise()
     ...
     */
    getUserFields(categoryId: string): Promise<any> {
        return this.http.get(this.RestUrlService.GET_FEED_USER_FIELDS_URL(categoryId)).toPromise()
            .then((response: any) => {
                return response;
            });
    }
     ...
     * @returns {Array}
     */
    getAvailableControllerServices(type: string): Promise<any> {
        return this.http.get(this.RestUrlService.LIST_SERVICES_URL("root"), { params: { type: type } }).toPromise()
            .then((response: any) => {
                return response;
            });
    }
    ...
    getPartitionFunctions() {
        return this.http.get(this.RestUrlService.PARTITION_FUNCTIONS_URL).toPromise()
            .then((response: any) => {
                return response;
            });
    }
    ...
    getFeedVersions(feedId: string) {
        ...
        return this.http.get(this.RestUrlService.FEED_VERSIONS_URL(feedId)).toPromise().then(successFn, errorFn);
    }
    ...
    getFeedVersion(feedId: string, versionId: string) {
        ...
        return this.http.get(this.RestUrlService.FEED_VERSION_ID_URL(feedId, versionId)).toPromise().then(successFn, errorFn);
    }
    ...
    diffFeedVersions(feedId: string, versionId1: string, versionId2: string) {
        ...
        return this.http.get(this.RestUrlService.FEED_VERSIONS_DIFF_URL(feedId, versionId1, versionId2)).toPromise().then(successFn, errorFn);
    }
