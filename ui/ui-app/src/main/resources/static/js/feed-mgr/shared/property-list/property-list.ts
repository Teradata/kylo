...
const moduleName = require('feed-mgr/module-name');
     ...
     */
    function PropertyListController($scope:any) {
        var self = this;
        ...
        self.onModelChange = function() {
            if (!angular.equals($scope.model, self.lastModel)) {
                ...
                // Sort properties
                $scope.propertyList.sort(function(a:any, b:any) {
        ...
        self.onPropertyChange = function() {
            ...
            angular.forEach($scope.propertyList, function(property:any) {
         ...
         */
        self.removeProperty = function(index:any) {
