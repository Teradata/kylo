        ...
        return {
            ...
            link: function ($scope,$element) {
                ...
                function buildAdminMenu() {
                    ...
                    links.push({sref: "sla-email-templates",type:'link', icon: "email", text: "SLA Email", defaultActive: false, permission: AccessConstants.EDIT_SERVICE_LEVEL_AGREEMENT_EMAIL_TEMPLATE});
