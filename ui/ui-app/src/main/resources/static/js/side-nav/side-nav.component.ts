...
export class SideNavComponent {
    ...
    buildFeedManagerMenu(): any {
        ...
        links.push({sref: "sla",type:'link', icon: "beenhere", text: this.translate.instant('views.main.sla'), permission: AccessConstants.UI_STATES.SERVICE_LEVEL_AGREEMENTS.permissions});
        ...
        links.push({sref: "catalog",type:'link', icon: "grid_on", text: this.translate.instant('views.main.tables'), permission: AccessConstants.UI_STATES.CATALOG.permissions});
    ...
    buildAdminMenu(): any{
        ...
        let links: any[] = [];
        links.push({sref: "catalog.admin-connectors",type: "link", icon: "settings_input_hdmi", text: this.translate.instant('views.main.catalogConnectors'), defaultActive: false, permission: AccessConstants.ADMIN_CONNECTORS});
