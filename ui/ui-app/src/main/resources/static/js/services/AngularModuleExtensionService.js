define(["require", "exports", "angular", "./module-name", "underscore", "./CommonRestUrlService", "./broadcast-service", "kylo-services-module"], function (require, exports, angular, module_name_1, _, CommonRestUrlService_1, broadcast_service_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AngularModuleExtensionService = /** @class */ (function () {
        function AngularModuleExtensionService($http, $q, $timeout, $uiRouter, CommonRestUrlService, BroadcastService, $urlMatcherFactory) {
            this.$http = $http;
            this.$q = $q;
        ...
        return AngularModuleExtensionService;
    }());
    exports.default = AngularModuleExtensionService;
    angular.module(module_name_1.moduleName)
        ...
        .factory("AngularModuleExtensionService", ["$http", "$q", "$timeout", "$uiRouter", "CommonRestUrlService", "BroadcastService", "$urlMatcherFactory", AngularModuleExtensionService]);
});
//# sourceMappingURL=AngularModuleExtensionService.js.map