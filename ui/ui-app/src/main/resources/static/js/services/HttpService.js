define(["require", "exports", "angular", "./module-name"], function (require, exports, angular, module_name_1) {
        ...
        function HttpService($q, $http) {
            ...
            this.getAllRequestBuilder = function (urls) {
                ...
                for (var i = 0; i < urls.length; i++) {
                    var rqst = new this.AbortableRequestBuilder(urls[i]).success(successFn).error(errorFn);
    ...
    angular.module(module_name_1.moduleName).service('HttpService', ['$q', '$http', HttpService]);
});
