define(["require", "exports", "angular", "./module-name", "moment", "pascalprecht.translate"], function (require, exports, angular, module_name_1, moment) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Utils = /** @class */ (function () {
        function Utils($timeout, $filter) {
            ...
            var data = {
                ...
                stickTabHeader2: function ($element, $tabsWrapper) {
                ...
                TimeDiffString: function (timeInMs) {
                    var diffString = moment.utc(timeInMs).format('HH:mm:ss'); // duration
                    if (diffString == '00') {
                        diffString = '0';
                    }
    ...
    angular.module(module_name_1.moduleName).factory('Utils', ["$timeout", "$filter", Utils]);
});
