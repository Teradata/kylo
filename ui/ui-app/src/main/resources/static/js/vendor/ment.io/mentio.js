                ...
                scope.$watch(
                    ...
                    function (newValue) {
                       ...
                       //     $log.error('Error, no mentio-items attribute was provided, ' +
                        //        'and no separate mentio-menus were specified.  Nothing to do.', newValue);
                            return;
                        }
...
angular.module('mentio')
    .factory('mentioUtil', ["$document","$window", "$location", "$anchorScroll", "$timeout", function ($document,$window, $location, $anchorScroll, $timeout) {
        ...
        function popUnderMention (ctx, triggerCharSet, selectionEl, requireLeadingSpace) {
            ...
            if (mentionInfo !== undefined) {
              ...
              //  console.log('SET TOP from ',coordinates.top,'to ',top);
                ...
                if(top > (windowHeight - menuHeight)) {
                    top -=320;
                }
                ...
                //  console.log('position ',selectionEl,coordinates,jQuery(getDocument(ctx).activeElement).offset(), selectionEl.offset().top)
        ...
        function replaceTriggerTextx (ctx, targetElement, path, offset, triggerCharSet,
                                     text, requireLeadingSpace, hasTrailingSpace) {
            resetSelection(ctx, targetElement, path, offset);
