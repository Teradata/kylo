...
import controller from "./alerts/AlertsDirective";
import * as DataConfidenceIndicatorDirective from "./data-confidence-indicator/DataConfidenceIndicatorDirective";
