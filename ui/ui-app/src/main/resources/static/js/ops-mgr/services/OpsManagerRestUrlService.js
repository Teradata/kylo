define(["require", "exports", "angular", "../module-name", "../module"], function (require, exports, angular, module_name_1) {
    "use strict";
    ...
    var OpsManagerRestUrlService = /** @class */ (function () {
        function OpsManagerRestUrlService() {
            ...
            */
            ...
            this.DAILY_STATUS_COUNT_URL = this.JOBS_BASE + "/daily-status-count/";
    ...
    exports.default = OpsManagerRestUrlService;
    angular.module(module_name_1.moduleName).service('OpsManagerRestUrlService', [OpsManagerRestUrlService]);
});
//# sourceMappingURL=OpsManagerRestUrlService.js.map