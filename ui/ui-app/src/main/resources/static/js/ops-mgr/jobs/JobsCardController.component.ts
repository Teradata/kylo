...
import { Component, Output, Input, OnChanges, SimpleChanges, Inject } from "@angular/core";
...
export class JobsCardController extends BaseFilteredPaginatedTableView implements OnChanges {
    ...
    @Input() hideFeedColumn: any;
    @Input() pageName: any;

    @Output() onJobAction: any;
    ...
    ngOnInit() {
         ...
         * @type {string}
         */
        this.filterJob = angular.isUndefined(this.filterJob) ? '' : this.filterJob;
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes.filterJob.currentValue !== changes.filterJob.previousValue) {
