define(['angular','ops-mgr/feeds/feed-stats/module-name'], function (angular,moduleName) {
    ...
    var directive = function () {
        return {
            ...
            controllerAs: 'vm',
            templateUrl: 'js/ops-mgr/feeds/feed-stats/feed-stats-top-n-processors.html',
    ...
    angular.module(moduleName).controller('FeedStatsTopNProcessorsController', ["$scope","$element","$http","$interval","$timeout","$q","ProvenanceEventStatsService","Nvd3ChartService",controller]);
