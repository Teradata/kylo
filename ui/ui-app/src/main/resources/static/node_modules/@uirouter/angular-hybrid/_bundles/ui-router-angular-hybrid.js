...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('angular'), require('@angular/core'), require('@angular/upgrade/static'), require('@angular/upgrade'), require('@uirouter/core'), require('@uirouter/angular'), require('@uirouter/angularjs'), require('@uirouter/rx')) :
	typeof define === 'function' && define.amd ? define(['exports', 'angular', '@angular/core', '@angular/upgrade/static', '@angular/upgrade', '@uirouter/core', '@uirouter/angular', '@uirouter/angularjs', '@uirouter/rx'], factory) :
	(factory((global['@uirouter/angular-hybrid'] = global['@uirouter/angular-hybrid'] || {}),global.angular,global.ng.core,global.ng.upgrade.static,null,global['@uirouter/core'],global['@uirouter/angular'],global['@uirouter/angularjs'],global['@uirouter/rx']));
}(this, (function (exports,angular,_angular_core,_angular_upgrade_static,_angular_upgrade,_uirouter_core,_uirouter_angular,_uirouter_angularjs,_uirouter_rx) { 'use strict';
...
UIViewNgUpgrade.decorators = [
    { type: _angular_core.Component, args: [{
                ...
                viewProviders: [{ provide: _uirouter_angular.UIView.PARENT_INJECT, useValue: {} }],
            },] },
];
/** @nocollapse */
