...
var UIView = /** @class */ (function () {
    ...
    UIView.prototype.ngOnInit = function () {
        ...
        this._deregisterHook = router$$1.transitionService.onBefore({}, function (trans) { return _this._applyUiCanExitHook(trans); });
     ...
     */
    UIView.prototype._applyUiCanExitHook = function (trans) {
    ...
    UIView.prototype._applyInputBindings = function (factory, component, context, componentClass) {
        ...
        var implicitInputTuples = ng2ComponentInputs(factory)
            .filter(function (tuple) { return !core.inArray(explicitBoundProps, tuple.prop); });
...
var UISref = /** @class */ (function () {
    ...
    UISref.prototype.go = function (button, ctrlKey, metaKey) {
        if (this._anchorUISref && (this._anchorUISref.openInNewTab() || button || !core.isNumber(button) || ctrlKey || metaKey)) {
            return;
        }
...
var UISrefStatus = /** @class */ (function () {
    ...
    UISrefStatus.prototype.ngAfterContentInit = function () {
        ...
        this._subscription = switchMap.switchMap.call(transEvents$, function (evt) {
...
function makeRootProviders(module) {
    return [
        ...
        { provide: core$1.APP_INITIALIZER, useFactory: onTransitionReady, deps: [core.TransitionService, UIROUTER_ROOT_MODULE], multi: true },
    ];
}
...
var _UIROUTER_INSTANCE_PROVIDERS = [
    { provide: core.UIRouter, useFactory: uiRouterFactory, deps: [common.LocationStrategy, UIROUTER_ROOT_MODULE, UIROUTER_MODULE_TOKEN, core$1.Injector] },
