(function () {
    ...
    var directive = function () {
        return {
            ...
            controllerAs: 'vm',
            templateUrl: 'js/jobs/summary/job-summary-pie-chart.html',
            controller: "JobSummaryPieChartController",
    ...
    angular.module(MODULE_OPERATIONS).controller('JobSummaryPieChartController', controller);

    angular.module(MODULE_OPERATIONS)
        .directive('tbaJobSummaryPieChart', directive);
