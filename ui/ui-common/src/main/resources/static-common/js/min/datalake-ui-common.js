...
}]);angular.module("datalakeui.common").run(["$templateCache", function($templateCache) {$templateCache.put("js/shared/card-layout/card-layout-template.html","<section class=\"md-whiteframe-z1 {{::cardCss}}\">\n     <div  ng-transclude=\"header1\" class=\"card-toolbar  {{::headerCss}}\" >\n\n    </div>\n    <md-content  ng-transclude=\"body1\" class=\"card-layout-body {{::bodyCss}}\" >\n\n    </md-content>\n\n</section>");
