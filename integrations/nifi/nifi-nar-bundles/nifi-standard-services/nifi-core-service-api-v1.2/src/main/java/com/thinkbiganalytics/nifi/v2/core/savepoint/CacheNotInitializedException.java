...
/**
 * Exception thrown if the Distributed cache is not initialized.
 * This will happen if the system attempts to access the cache for the first time if its not built
 */
