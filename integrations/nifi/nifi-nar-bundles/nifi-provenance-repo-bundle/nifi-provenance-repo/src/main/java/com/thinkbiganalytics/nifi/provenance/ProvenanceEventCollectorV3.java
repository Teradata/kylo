 ...
 */
public class ProvenanceEventCollectorV3 {

    private static final Logger log = LoggerFactory.getLogger(ProvenanceEventCollectorV3.class);
    @Autowired
    ...
    @Autowired
    public ProvenanceEventCollectorV3(@Qualifier("provenanceEventActiveMqWriter") ProvenanceEventActiveMqWriter provenanceEventActiveMqWriter) {
        super();
