...
@Tags({"spark", "thinkbig"})
@CapabilityDescription("Deletes a Spark Context from Job Server")
public class DeleteSparkContext extends AbstractNiFiProcessor {
    ...
    public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException {
        ...
        Boolean success = jobService.deleteContext(contextName);
