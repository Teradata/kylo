...
public class CreateSparkContext extends AbstractNiFiProcessor {
    ...
    public static final PropertyDescriptor NUM_CPU_CORES = new PropertyDescriptor.Builder()
        ...
        .description("CPU Cores allocated to each executor in Spark Contextr")
        .required(true)
        .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
        .expressionLanguageSupported(true)
        .build();
    ...
    public static final PropertyDescriptor MEM_PER_NODE = new PropertyDescriptor.Builder()
        ...
        .description("Memory allocated to each executor in ")
        .required(true)
        .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
        .expressionLanguageSupported(true)
        .build();
    ...
    public void onTrigger(ProcessContext context, ProcessSession session) throws ProcessException {
        ...
        Boolean success = jobService.createContext(contextName, numExecutors, memPerNode, numCPUCores);
