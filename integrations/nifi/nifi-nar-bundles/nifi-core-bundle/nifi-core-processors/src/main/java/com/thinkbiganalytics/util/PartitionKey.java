...
public class PartitionKey implements Cloneable {
    ...
    public String toPartitionNameValue(final String value) {
        ...
        if (value == null) {
            safeValue = null;
        } else if ("binary".equalsIgnoreCase(type) || "char".equalsIgnoreCase(type) || "date".equalsIgnoreCase(type) || "string".equalsIgnoreCase(type) || "timestamp".equalsIgnoreCase(type)
