...
public interface NiFiConnectionsRestClient {
     ...
     */
    @Nonnull
    Optional<ConnectionDTO> findById(@Nonnull String processGroupId, @Nonnull String connectionId);

    /**
     * Lists the contents of the queue for the specified connection.
     *
     * @param processGroupId the process group id
     * @param connectionId the connection id
     * @return the queue
     ...
     */
    @Nonnull
    ListingRequestDTO getQueue(@Nonnull String processGroupId, @Nonnull String connectionId);
}
