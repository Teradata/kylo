 ...
 */
public interface SavepointReplayEventConsumer {
     ...
     */
    void addListener(SavepointReplayEventListener listener);
     ...
     */
    void removeListener(SavepointReplayEventListener listener);
}
