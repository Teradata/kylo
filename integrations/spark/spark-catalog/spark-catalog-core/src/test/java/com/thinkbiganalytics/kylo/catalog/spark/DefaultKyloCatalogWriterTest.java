...
public class DefaultKyloCatalogWriterTest {
    ...
    public void addJar() {
        ...
        // Test adding jars
        final DefaultKyloCatalogWriter reader = new DefaultKyloCatalogWriter(Mockito.mock(KyloCatalogClient.class), new Configuration(false), resourceLoader, Mockito.mock(Object.class));
    ...
    public void option() {
        ...
        final DefaultKyloCatalogWriter reader = new DefaultKyloCatalogWriter(Mockito.mock(KyloCatalogClient.class), conf, Mockito.mock(DataSourceResourceLoader.class), Mockito.mock(Object.class));
