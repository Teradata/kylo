...
/**
 * A data set provider that can read from and write to Hive tables using Spark 2.
 */
public class HiveDataSetProviderV2 extends AbstractHiveDataSetProvider<Dataset<Row>> {
