...
public class InvalidRowPercentRuleImpl implements DataQualityRule {
    ...
    public InvalidRowPercentRuleImpl() {
        ...
        this.description = "Rule Desc: Percent of (Invalid rows/ Total rows) < " +
    ...
    public boolean loadAttributes(FlowAttributes flowAttr) {
        try {
            ...
            if (flowAttr.containsAttribute(DataQualityConstants.DQ_INVALID_ALLOWED_PERCENT_ATTRIBUTE))
                invalidThreshold = flowAttr.getAttributeValueLong(DataQualityConstants.DQ_INVALID_ALLOWED_PERCENT_ATTRIBUTE);
            else
                invalidThreshold = DataQualityConstants.DEFAULT_INVALID_ALLOWED_PERCENT_VALUE;
    ...
    public boolean evaluate() {
        try {
            // Execute rule
            long pctInvalid = invalidRowCount / feedRowCount;
