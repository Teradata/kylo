...
public class IntegerColumnStatistics extends StandardColumnStatistics {
    ...
    public List<OutputRow> getStatistics() {
        ...
        rows.add(new StandardOutputRow(columnField.name(), String.valueOf(MetricType.MEAN), String.valueOf(df.format(mean))));
        rows.add(new StandardOutputRow(columnField.name(), String.valueOf(MetricType.STDDEV), String.valueOf(df.format(stddev))));
        rows.add(new StandardOutputRow(columnField.name(), String.valueOf(MetricType.VARIANCE), String.valueOf(df.format(variance))));
        return rows;
    }
