 ...
 */
public class DefaultSparkShellClusterListener implements SparkShellClusterListener {

    private static final Logger log = LoggerFactory.getLogger(DefaultSparkShellClusterListener.class);
    ...
    /**
     * Constructs a {@code DefaultSparkShellClusterListener}.
     *
     * @param clusterService the Kylo cluster service
     * @param delegate       the process manager
     */
    public DefaultSparkShellClusterListener(@Nonnull final ClusterService clusterService, @Nonnull final SparkShellClusterDelegate delegate) {
