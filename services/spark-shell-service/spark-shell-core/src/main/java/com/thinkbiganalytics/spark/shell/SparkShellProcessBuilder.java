        ...
        if (appResource == null) {
            ...
            appResource = Stream.of(new EnvironmentAppLocator(), new CodeSourceAppLocator())
                ...
                .orElseThrow(() -> new IllegalStateException(
                    "Unable to find the Kylo Spark Shell Client app. Either set it explicitly or use the KYLO_SERVICES_HOME environment variable. The resource name is: " + resourceName));
        }
        return appResource;
    }
