 ...
 */
@FunctionalInterface
public interface FeedImporterFactory<O extends ImportFeedOptions, R extends FeedImporter> {

    public R apply(String fileName, byte[] content, O importFeedOptions);
}
