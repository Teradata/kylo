...
/**
 * Functional interface for new TemplateImporter
 */
@FunctionalInterface
public interface TemplateImporterFactory<O extends ImportOptions, R extends TemplateImporter> {

    public R apply(String fileName, byte[] content, O importOptions);
}
