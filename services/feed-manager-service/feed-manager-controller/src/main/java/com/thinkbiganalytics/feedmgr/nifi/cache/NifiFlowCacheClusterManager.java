...
public class NifiFlowCacheClusterManager implements ClusterServiceListener {
    ...
    public NifiFlowCacheClusterUpdateMessage  updateFeed(String feedName, boolean isStream,  String feedProcessGroupId,Collection<NifiFlowProcessor> processors, Collection<NifiFlowConnection> connections) {
