 ...
 * 
 */
package com.thinkbiganalytics.metadata.upgrade.v0_7_0;
 ...
 */
@Component("feedManagerSecurityUpgradeAction0.7.0")
@Order(UpgradeAction.DEFAULT_ORDER + 700)  // Order only relevant during fresh installs
