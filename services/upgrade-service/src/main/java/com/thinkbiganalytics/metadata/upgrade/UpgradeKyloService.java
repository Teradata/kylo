...
import static com.thinkbiganalytics.KyloVersionUtil.*;
...
import com.thinkbiganalytics.metadata.upgrade.version_0_4_0.UpgradeAction;
...
//        KyloVersion version = versionProvider.getCurrentVersion();
//        if (version != null) {
...
//        versionProvider.updateToLatestVersion();
//        return versionProvider.isUpToDate();
//    }
//
...
//
//            //update the version
//            //  return versionProvider.updateToLatestVersion();
//        }), MetadataAccess.SERVICE);
//    }
//
//
