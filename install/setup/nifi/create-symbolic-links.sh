...
if [ grep "nifi.version=0." /opt/nifi/current/conf/nifi.properties >/dev/null 2>&1 ]; then
    ln -f -s /opt/nifi/data/lib/thinkbig-nifi-spark-nar-*.nar /opt/nifi/current/lib/thinkbig-nifi-spark-v0-nar.nar
    ln -f -s /opt/nifi/data/lib/thinkbig-nifi-hadoop-nar-*.nar /opt/nifi/current/lib/thinkbig-nifi-hadoop-v0-nar.nar
    ln -f -s /opt/nifi/data/lib/thinkbig-nifi-hadoop-service-nar-*.nar /opt/nifi/current/lib/thinkbig-nifi-hadoop-service-v0-nar.nar
else
    ln -f -s /opt/nifi/data/lib/thinkbig-nifi-spark-nar-*.nar /opt/nifi/current/lib/thinkbig-nifi-spark-v0-nar.nar
    ln -f -s /opt/nifi/data/lib/thinkbig-nifi-hadoop-nar-*.nar /opt/nifi/current/lib/thinkbig-nifi-hadoop-v1-nar.nar
    ln -f -s /opt/nifi/data/lib/thinkbig-nifi-hadoop-service-nar-*.nar /opt/nifi/current/lib/thinkbig-nifi-hadoop-service-v1-nar.nar
fi
