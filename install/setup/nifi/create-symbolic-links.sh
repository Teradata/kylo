...
if grep -q "nifi.version=0." /opt/nifi/current/conf/nifi.properties; then
    ln -f -s /opt/nifi/data/lib/kylo-nifi-core-v0-nar-*.nar /opt/nifi/current/lib/kylo-nifi-core-nar.nar
    ln -f -s /opt/nifi/data/lib/kylo-nifi-spark-v0-nar-*.nar /opt/nifi/current/lib/kylo-nifi-spark-nar.nar
    ln -f -s /opt/nifi/data/lib/kylo-nifi-hadoop-v0-nar-*.nar /opt/nifi/current/lib/kylo-nifi-hadoop-nar.nar
    ln -f -s /opt/nifi/data/lib/kylo-nifi-hadoop-service-v0-nar-*.nar /opt/nifi/current/lib/kylo-nifi-hadoop-service-nar.nar
    ln -f -s /opt/nifi/data/lib/kylo-nifi-provenance-repo-v0-nar-*.nar /opt/nifi/current/lib/kylo-nifi-provenance-repo-nar.nar
    ln -f -s /opt/nifi/data/lib/kylo-nifi-elasticsearch-v0-nar-*.nar /opt/nifi/current/lib/kylo-nifi-elasticsearch-nar.nar
else
