...
CREATE TABLE `BATCH_NIFI_JOB` (
  ...
  `NIFI_EVENT_ID` bigint(20) DEFAULT NULL,
  `FLOW_FILE_ID` varchar(255) NOT NULL DEFAULT '',
  ...
  UNIQUE KEY `BATCH_NIFI_JOB_UQ1` (`JOB_EXECUTION_ID`),
...
(`PK_COLUMN`,
`VALUE_COLUMN`)
VALUES('JOB_INSTANCE_ID',0);

INSERT INTO `thinkbig`.`GENERATED_KEYS`
(`PK_COLUMN`,
`VALUE_COLUMN`)
VALUES('JOB_EXECUTION_ID',0);

INSERT INTO `thinkbig`.`GENERATED_KEYS`
(`PK_COLUMN`,
`VALUE_COLUMN`)
VALUES('STEP_EXECUTION_ID',0);
