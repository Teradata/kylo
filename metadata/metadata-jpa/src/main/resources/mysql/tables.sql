...
create table FEED (id binary(16) not null, created_time datetime, modified_time datetime, description varchar(255), display_name varchar(100), name varchar(100) not null, state varchar(10) not null, sla_id binary(16), primary key (id)) ENGINE=InnoDB;
