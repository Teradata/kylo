...
/**
 * Hold status of data history reindexing for a feed (domain model)
 */
public class HistoryReindexingStatus {

    private final HistoryReindexingState historyReindexingState;
    private final DateTime lastModifiedTimestamp;
