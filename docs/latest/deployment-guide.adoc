...
1. Configuring Kerberos For Your Local HDP Sandbox
...
3. Configure Kerberos for Kylo Applications

    Additional configuration is required for allowing some features in the Kylo applications to work with a Kerberos cluster

link:./security/kerberos/kylo-configuration-kerberos-cluster.adoc[Configure Kylo for Kerberos]
